...
const StyledHeading = styled.h1`
  font-size: ${(props) => (props.size ? fontSize[props.size - 1] : fontSize[0])};
  -moz-osx-font-smoothing: grayscale;
  -webkit-font-smoothing: antialiased;
  font-weight: ${(props) => (props.size ? fontWeight[props.size - 1] : fontWeight[0])};
  line-height: ${(props) => (props.size ? lineHeight[props.size - 1] : lineHeight[0])};
  letter-spacing: ${(props) => (props.size ? letterSpacing[props.size - 1] : letterSpacing[0])};
