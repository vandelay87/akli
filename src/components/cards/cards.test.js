...
import { card, cardWithSubtitle, cardsWithImage, cardWithLink } from './cards.stories';
...
describe('cards.js', () => {
  it('renders component', () => {
    const cardTree = renderer
      .create(card())
      .toJSON();
    const cardWithSubtitleTree = renderer
      .create(cardWithSubtitle())
      .toJSON();
    const cardsWithImageTree = renderer
      .create(cardsWithImage())
      .toJSON();
    const cardWithLinkTree = renderer
      .create(cardWithLink())
      .toJSON();
