...
describe('chips.js', () => {
  it('renders component', () => {
    const chipsActionTree = renderer.create(chipsWithAction()).toJSON()
    const chipsLinkTree = renderer.create(chipsWithLink()).toJSON()
  ...
  it('calls function', () => {
    ...
    const wrapper = mount(
      <Chips list={[{ id: '1', value: 'chip', action: mockFn }]} />
    )
